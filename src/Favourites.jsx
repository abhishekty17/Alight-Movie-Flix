...
function Favourites() {
  let [Favourite, setFavourite] = React.useState([
    ...
    },
    {
      ...
      "poster_path": "/clAMlA3DcwKMJIYeAFGGN0vyJQp.jpg",
      "media_type": "movie",
      "genre_ids": [
        10749,
        18
    ...
    },
    {
      ...
      "overview": "A truck driver has been forced to smuggle illicit cargo to save her brother from a deadly prison gang. With FBI operatives hot on her trail, Sally's conscience is challenged when the final package turns out to be a teenage girl.",
    ...
    {
      "adult": false,
      "backdrop_path": "/irDiMv0ddrr2evxntiEje9B1t1U.jpg",
      "id": 366672,
...
function Genre(props) {
  ...
  let newMovieArray = searchArray(props.Favourite, searchvalue);
  ...
  sortRatingfunc(ratingOrder, newMovieArray);
  sortPopularityfunc(popularityOrder, newMovieArray);
  ...
  return (
    <>
      ...
      <input Type="text" onChange={setSearchValueHandler} value={searchvalue}></input>
      ...
      <table>
        ...
        <tbody>
          {newMovieArray.map((element, idx) => {
            return (
              <tr>
                <td><img src={"https://image.tmdb.org/t/p/original" + element.poster_path} className="allmovieimg"></img></td>
...
function sortRatingfunc(ratingOrder, favourites) {
  if (ratingOrder === null) {
    return favourites;
  }
  function helper(a, b) {
...
function sortPopularityfunc(popularityOrder, favourites) {
  ...
  // [1,5,4,2,7]
  let popularFavourites = favourites.sort(helper);
  return popularFavourites;
}
